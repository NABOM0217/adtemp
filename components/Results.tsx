 ...
 *
 * basis 는 2026-08-21부터 카드에 찍지 않는다(사장님 지시 — 네 줄이 되니 순위가 안 읽혔다).
 * 삭제하지 말 것: 아래 ZOOMS 가 확대 캡션에 쓰고 있고, 그게 남은 유일한 시점 표기다.
 */
const RANKS = [
  ...
  return (
    <section className="sec" id="results" style={{ background: 'var(--panel)' }}>
      <div className="shell reveal" ref={ref}>
        ...
        {/*
          근거 표기 — 표시광고법 실증 대비, 시안엔 없던 보완.
          카드에서 측정 시점을 뺐으므로(사장님 지시) "각각 표기했습니다"는 사실과 어긋난다.
          시점은 확대 캡션에 남아 있으니 그쪽으로 안내한다.
          실증 자료를 어디서 볼 수 있는지는 반드시 남아 있어야 한다.
        */}
        <p className="rank-basis">
          ※ 네이버 검색 기준. 키워드마다 검색 영역과 측정 시점이 다릅니다. 아래 캡처를 클릭하면
          원본과 측정 시점을 확인하실 수 있습니다.
        </p>
